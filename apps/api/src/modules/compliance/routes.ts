...
async function seedCJIS(db: any, tenantId: string) {
  ...
  const areas = [
    ...
    { code: 'PA-2', title: 'Security Awareness Training', controls: [
      { code: '5.2.1', title: 'Awareness Topics', desc: 'Training must cover CJI handling, incident reporting, password security', nist: 'AT-2', type: 'administrative' },
      { code: '5.2.2', title: 'Training Records', desc: 'All training records documented and maintained', nist: 'AT-4', type: 'administrative' },
      { code: '5.2.3', title: 'Training Frequency', desc: 'Within 6 months of assignment, refresher annually', nist: 'AT-2', type: 'administrative' },
    ]},
    ...
    { code: 'PA-4', title: 'Auditing and Accountability', controls: [
      { code: '5.4.1', title: 'Auditable Events', desc: 'Log login attempts, data access, admin actions', nist: 'AU-2', type: 'technical' },
      { code: '5.4.2', title: 'Content of Audit Records', desc: 'Logs include who, what, when, where, outcome', nist: 'AU-3', type: 'technical' },
      { code: '5.4.3', title: 'Audit Monitoring', desc: 'Regular review and analysis of audit records', nist: 'AU-6', type: 'technical' },
      { code: '5.4.4', title: 'Time Stamps', desc: 'System clocks synchronized via NTP', nist: 'AU-8', type: 'technical' },
      { code: '5.4.5', title: 'Protection of Audit Info', desc: 'Audit logs protected from unauthorized access', nist: 'AU-9', type: 'technical' },
      { code: '5.4.6', title: 'Audit Record Retention', desc: 'Minimum 365-day retention', nist: 'AU-11', type: 'administrative' },
    ]},
    { code: 'PA-5', title: 'Access Control', controls: [
      { code: '5.5.1', title: 'Account Management', desc: 'Formal account management for CJI systems', nist: 'AC-2', type: 'administrative' },
      { code: '5.5.2', title: 'Access Enforcement', desc: 'Systems enforce approved authorizations', nist: 'AC-3', type: 'technical' },
      { code: '5.5.3', title: 'Unsuccessful Login Attempts', desc: 'Lockout after 5 failed attempts', nist: 'AC-7', type: 'technical' },
      { code: '5.5.4', title: 'System Use Notification', desc: 'Login banner before CJI system access', nist: 'AC-8', type: 'technical' },
      { code: '5.5.5', title: 'Session Lock', desc: '30-minute inactivity lock', nist: 'AC-11', type: 'technical' },
      ...
      { code: '5.5.9', title: 'Least Privilege', desc: 'Minimum access necessary for job function', nist: 'AC-6', type: 'administrative' },
    ...
    { code: 'PA-6', title: 'Identification and Authentication', controls: [
      { code: '5.6.1', title: 'Unique Identification', desc: 'Each user has unique ID, no shared accounts', nist: 'IA-4', type: 'administrative' },
      { code: '5.6.2', title: 'Authentication Policy', desc: 'Documented authentication requirements', nist: 'IA-1', type: 'administrative' },
      { code: '5.6.3', title: 'Standard Authentication', desc: '8+ chars, complexity, 90-day expiration', nist: 'IA-5', type: 'technical' },
      { code: '5.6.4', title: 'Advanced Authentication (MFA)', desc: 'MFA for remote/elevated CJI access', nist: 'IA-2', type: 'technical', severity: 'critical' },
      { code: '5.6.5', title: 'Identifier Management', desc: 'Disable after 90 days inactive', nist: 'IA-4', type: 'administrative' },
    ...
    { code: 'PA-7', title: 'Configuration Management', controls: [
      ...
      { code: '5.7.2', title: 'Least Functionality', desc: 'Minimum services, ports, protocols', nist: 'CM-7', type: 'technical', severity: 'high' },
    ...
    { code: 'PA-10', title: 'Systems and Communications Protection', controls: [
      { code: '5.10.1', title: 'Boundary Protection', desc: 'Firewalls/DMZs at CJI network boundaries', nist: 'SC-7', type: 'technical', severity: 'critical' },
      ...
      { code: '5.10.3', title: 'Intrusion Detection', desc: 'IDS/IPS on CJI network segments', nist: 'SI-4', type: 'technical', severity: 'high' },
      ...
      { code: '5.10.6', title: 'Encryption at Rest', desc: 'FIPS 140-2 encryption for stored CJI', nist: 'SC-28', type: 'technical', severity: 'critical' },
